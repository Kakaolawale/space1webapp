...
const HeroBanner2 = () => {
  return (
    <div className="w-full p-10  ... bg-cover  bg-space1seven h-96 shadow">
            <div className="flex flex-col text-space1-4 items-center justify-center">
                <h1 className="text-4xl font-bold">COOLEST BEACH HOTELS.</h1>
             ...
             beach-front pool and gardens, and a wide range of family oriented activities.
                ...
                <div className="items-center justify-center mt-4">
                    <button className="px-6 py-2 text-center text-avista2 bg-avista3 rounded-md shadow-md">
                      Book Now
                    </button>
                </div>
            </div>
